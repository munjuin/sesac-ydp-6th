...
//외부 라이브러리라서 설치 필요
//양방향 암호화는 지원하지 않음, 비밀번호 암호화에 특화된 모듈
...
//솙트의 생성 라운드 수 -> 2의 거듭제곱 형태
//rounds: bcrypt 에서 해시함수를 반복하는 횟수
...
console.log(isMatch ? '비밀번호일치' : '비밀번호 불일치');

const isMatch2 = comparePw('12344', hashedPw);
console.log(isMatch2 ? '비밀번호일치' : '비밀번호 불일치');
