...
//  }
  ...
  public void goToSchool(){
    System.out.println(this.name+"(이)가 학교에 간다");
  }

  //2. 인자 o, 반환값 x
  public void study(String subject){
    System.out.println(this.name+"(이)가"+subject+"과목을 공부한다");
  }
